...
- VECTOR HUNTER: 室内を速度105px/秒で巡回。0.8秒の予告線の後、0.35秒の直線レーザーを発射し、追跡型とスナイパー型を召喚します。予告中は位置を止め、攻撃ラインを安定させます。召喚時はプレーヤーから96px以上離し、0.65秒の認識時間を設けます。
...
3種類とも時間制限なしで、本体のHP予算は従来と同じ。回避を省いた実弾・移動テストでは砲台型約11秒、移動型約15〜20秒、弾幕型約10秒。実際の回避込みの所要時間はプレイ状況によります。
